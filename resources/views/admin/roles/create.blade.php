...
<script>
  function selectAll(state) {
    const form = document.querySelector('form[action="{{ route('roles.store') }}"]') || document.querySelector('form');
    if (!form) return;
  ...
  // optional: keep toggleGroup for button compatibility
