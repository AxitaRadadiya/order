...
<head>
    ...
    <title>Live by life — Register</title>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .status-ok{background:rgba(34,197,94,.08);border:1px solid rgba(34,197,94,.2);border-radius:8px;padding:.7rem 1rem;font-size:.8rem;color:var(--green);margin-bottom:1.2rem;display:flex;align-items:center;gap:.5rem}
    .status-warn{background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.2);border-radius:8px;padding:.7rem 1rem;font-size:.8rem;color:#f59e0b;margin-bottom:1.2rem;display:flex;align-items:flex-start;gap:.5rem;line-height:1.5}

    .field{margin-bottom:14px}
    .field label{display:block;font-size:.72rem;font-weight:700;color:var(--text2);margin-bottom:6px;letter-spacing:.8px;text-transform:uppercase}
    ...
    .input-wrap input{width:100%;height:44px;background:var(--bg3);border:1px solid var(--border2);border-radius:9px;padding:0 44px 0 38px;font-size:.88rem;font-family:sans-serif;color:black;outline:none;transition:border-color .2s,box-shadow .2s}
    ...
    .eye-btn{position:absolute;right:12px;background:none;border:none;cursor:pointer;padding:0;display:flex;align-items:center}
    ...
    .btn-submit{width:100%;height:46px;background:linear-gradient(135deg,#6c63ff,#a855f7);border:none;border-radius:9px;color:#fff;font-family:var(--sans);font-size:.9rem;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 6px 24px rgba(108,99,255,.35);transition:transform .18s,box-shadow .18s;letter-spacing:.02em}
