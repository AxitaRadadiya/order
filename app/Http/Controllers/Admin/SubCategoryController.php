...
class SubCategoryController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        foreach ($rows as $row) {
            ...
            if (auth()->user()) {
                $actions .= '<a href="#" data-id="'.$row->id.'" data-name="'.e($row->name).'" data-category-id="'.$row->category_id.'" class="btn btn-sm btn-info edit-sub-category-date-modal"><i class="fa fa-edit"></i></a>';
            }
            if (auth()->user()) {
